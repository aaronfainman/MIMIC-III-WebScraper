...
% GOOGLENET EDITED VIA DEEP NETWORK DESIGNER

params = load("GoogLeNet_Params.mat");
lgraph = layerGraph();
tempLayers = [
...
tempLayers = [
    ...
    fullyConnectedLayer(1000,"Name","loss3-predictor","BiasLearnRateFactor",2,"Bias",params.loss3_predictor.Bias,"Weights",params.loss3_predictor.Weights)
